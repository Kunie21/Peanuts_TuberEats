...
static float			g_AngleUpDown = 1.0f;
...
void SetViewPort(int type)
{
	...
	//	vp.TopLeftX = 0;
	//	vp.TopLeftY = 0;
	//	vp.Width = (FLOAT)GetWinWidth();
	//	vp.Height = (FLOAT)GetWinHeight();
	//	break;
	...
	//	vp.MinDepth = 0.0f;
	//	vp.MaxDepth = 1.0f;
	//	vp.TopLeftX = (FLOAT)GetWinWidth() / 2;
	//	vp.TopLeftY = 0;
	//	vp.Width = (FLOAT)GetWinWidth() / 2;
	//	vp.Height = (FLOAT)GetWinHeight();
	//	break;
	...
	//case TYPE_UP_HALF_SCREEN:
	//	vp.Width = (FLOAT)GetWinWidth();
	//	vp.Height = (FLOAT)GetWinHeight() / 2;
	//	vp.MinDepth = 0.0f;
	//	vp.MaxDepth = 1.0f;
	//	vp.TopLeftX = 0;
	//	vp.TopLeftY = 0;
	...
	//	vp.MaxDepth = 1.0f;
	//	vp.TopLeftX = 0;
	//	vp.TopLeftY = (FLOAT)GetWinHeight() / 2;
	//	break;
	//}
...
// カメラの視点と注視点をセット
void SetCameraRad(float pos_y, float rad)
{
	//g_Camera.at = XMFLOAT3(0.0f, pos_y + 1.5f * WALL_RADIUS * g_AngleUpDown, 0.0f);
	//g_Camera.at = XMFLOAT3(0.0f, pos_y - 1.5f * WALL_RADIUS, 0.0f);		// 上面確認用

	//g_Camera.pos.y = pos_y - 0.5f * WALL_RADIUS;
	//g_Camera.pos.x = 1.5f * WALL_RADIUS * cosf(-rad);
	//.pos.z = 1.5f * WALL_RADIUS * sinf(-rad);
}


void SetCameraRadResult(XMFLOAT3 at_pos, float view_ypos, float radian, float radius)
{
	g_Camera.at = at_pos;		// 上面確認用

	g_Camera.pos.y = view_ypos;
	g_Camera.pos.x = radius * cosf(-radian);
	g_Camera.pos.z = radius * sinf(-radian);
}

void SetCameraRadResult(XMFLOAT3 at_pos, XMFLOAT3 pos)
{
	g_Camera.at = at_pos;		// 上面確認用
